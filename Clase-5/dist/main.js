...
const Empleados_js_1 = require("../src/Types/Empleados.js");
/* CORRECTO a*/
class ManejadorEmpleados {
    ...
    agregar_empleado(nombre, sueldo, fecha_de_contratacion, puesto) {
        const nuevoEmpleado = new Empleados_js_1.Empleado(nombre, sueldo, fecha_de_contratacion, puesto, this.id_empleados++);
...
const pasante_1 = new Empleados_js_1.Pasante('Pepe', 200000, '20/8/2024', 'Developer', 2, 3);
